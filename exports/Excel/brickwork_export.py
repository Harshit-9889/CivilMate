...
def export_brickwork_report(
    ...
    ws.title = "Brickwork Estimate"

    ws.merge_cells("A1:E1")

    ws["A1"] = "BRICKWORK ESTIMATION REPORT"
    ws["A1"].font = Font(
    bold=True,
    size=16
    )
    ...
    ws["C9"] = "Nos"
    ws["D9"] = brick_rate
    ws["E9"] = costs["brick_cost"]

    ws["A10"] = "cement"
    ws["B10"] = cement_bags
    ws["C10"] = "bags"
    ws["D10"] = cement_rate
    ws["E10"] = costs["cement_cost"]
